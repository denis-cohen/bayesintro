...
### Let's inspect this in detail, step-by-step
...
```{r warmup-zoom-display, fig.align='center', fig.width = 6, fig.height = 6}
...
We will ensure that ou chains run independently (i.e., using different
...
-   Bayesian inference does note presume large (quasi-infinite) streams
    of independent identically distributed (IID) data; data are
    considered fixed, parameters random.
-   This allows for straightforward interpretations of inferential
    uncertainty.
