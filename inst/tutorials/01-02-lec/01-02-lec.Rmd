...
We draw $\mu_1$ from the conditional conjugate posterior, given $\sigma_1^2$:
...
### Step 3a: Sampling warm-up draws
...
We therefore "zoom" in to the rectangulaer area inbetween the yellow lines.
