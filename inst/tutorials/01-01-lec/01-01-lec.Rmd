...
1. logical and numerical object slicing
...
- This course:
    - "background code" for teaching examples may use one or the other
    - Exercises and solutions will use the `tidyverse`
